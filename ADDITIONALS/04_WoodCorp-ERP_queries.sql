...
25. Late Delivery Qty :

SUM(
  CASE 
    WHEN "_APX_WDCRP_CASES"."PROMISED_DATE" < "_APX_WDCRP_CASES"."DELIVERED_DATE" 
    -- AND "_APX_WDCRP_CASES"."DELIVERED_QUANTITY" != "_APX_WDCRP_CASES"."ORDERED_QUANTITY"
    -- THEN "_APX_WDCRP_CASES"."DELIVERED_QUANTITY" 
        THEN "_APX_WDCRP_CASES"."ORDERED_QUANTITY"
    ELSE 0.0 
  END
) 

26. Late Delivered Fee :

SUM(
  CASE 
    WHEN "_APX_WDCRP_CASES"."DELIVERED_DATE" > "_APX_WDCRP_CASES"."PROMISED_DATE" 
  --   THEN "_APX_WDCRP_CASES"."DELIVERED_QUANTITY" * 0.75    -- 11,824,769
       THEN "_APX_WDCRP_CASES"."ORDERED_QUANTITY" * 0.75      -- 11,822,823
    ELSE 0 
  END
)

27. Not Delivered Qty :

SUM(
  CASE 
    WHEN "_APX_WDCRP_CASES"."ORDERED_QUANTITY" > "_APX_WDCRP_CASES"."DELIVERED_QUANTITY"
    AND "_APX_WDCRP_CASES"."PROMISED_DATE" <= "_APX_WDCRP_CASES"."DELIVERED_DATE"
--    THEN "_APX_WDCRP_CASES"."ORDERED_QUANTITY" - "_APX_WDCRP_CASES"."DELIVERED_QUANTITY"
    THEN "_APX_WDCRP_CASES"."DELIVERED_QUANTITY"
    ELSE 0.0 
  END
